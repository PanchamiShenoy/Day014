...
public class StockAccount  {
    ...
    public void buy(int amount, String symbol) {
        ...
        while (itr.hasNext()) {
            ...
            if (stock.get("stockSymbol").equals(symbol)) {
                numberOfShares = (double) stock.get("numberOfShares");
            }
        }
    ...
    private void updateValue(String symbol, long numberOfShares, CompanyShare companyShare, String state) {
        ...
        double prevShares = companyShare.getNumberOfShares();
        ...
        while (itr.hasNext()) {
            JSONObject stock = itr.next();
            if (stock.get("stockSymbol").equals(symbol)) {
                prevShares = (double)stock.get("numberOfShares");
        ...
        try {
            FileWriter writer = new FileWriter("/Users/panchamishenoy/Desktop/assignment/Day014/data/stock2.json");
    ...
    public void save(String filename) {
        ...
        for (CompanyShare companyShare : companyShares) {
            ...
            double numberOfShares = companyShare.getNumberOfShares();
    ...
    public void printReport() {
        ...
        for (CompanyShare companyShare : companyShares) {
        	  ...
        	  System.out.println("Number of Shares Holding : " + companyShare.getNumberOfShares());
            double valueEach = 0;
    ...
    public double valueof(CompanyShare companyShare) {
        JSONArray stockData=readJSON();
        //System.out.println(stocksData);
        Iterator<JSONObject> itr = stocksData.iterator();
